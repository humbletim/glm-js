...
$GLM_extern = function(func, local) {
   ...
   return function() { 
      ...
      GLM.$outer.console.debug('$GLM_extern: resolved external symbol '+func+' '+typeof GLM[local]);
            ...
            [2,3,4].forEach(
               function(N){
                  ...
                  if (!( kn in TSP )) {
                     ...
                     TSP[kn] = new Function("", "return "+(tpl+'').replace(/N/g,N))();
...
GLM.$to_object = GLM.$template.calculators(
   {
      $to_object: {
