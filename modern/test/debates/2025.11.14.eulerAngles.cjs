...
try {
  console.log('Dusk says:', Dusk.eulerAngles(q).toString());
} catch (e) {
  console.log('Dusk: Error', e.message);
}

try {
  console.log('Day says:', Day.eulerAngles(q_day).toString());
} catch (e) {
  console.log('Day: Error', e.message);
}

try {
  console.log('Dawn says:', Dawn.eulerAngles(q_dawn).toString());
} catch (e) {
