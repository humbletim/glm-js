...
[e.$op,"!=",c.$op].join(" ")+'"  p='+[b,e.$op,c.$op,"||"+Object.keys(e.$template).join("||")]);var f=GLM.$template[a](GLM.$template.deNify(c,b),b);f.$op=c.$op;if(e){var g=[],h;for(h in f.$template)h in e.$template||(GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+h+" overlayed"),e.$template[h]=f.$template[h]);Object.keys(e.$template).forEach(function(a){a in f.$template||(GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+a+" carried-forward"),g.push(a))});
...
e;for(e in a){var f=!1;e.replace(/([vV]ec|[mM]at)(?:\w*)<N>/,function(g,h){f=!0;var k=a[e];delete a[e];c[h.toLowerCase()].forEach(function(c){var f=e.replace(/<N[*]N>/g,c*c).replace(/<N>/g,c);if(!(f in a)){var g=d("glm_"+b+"_"+f);a[f]=(new Function("","'use strict'; return "+(k+"").replace(/^function\s*\(/,"function "+g+"(").replace(/N[*]N/g,c*c).replace(/N/g,c)))()}})}.bind(this));/^[$]/.test(e)?GLM.$DEBUG&&GLM.$outer.console.debug("@ NOT naming "+e):!f&&("function"===typeof a[e]&&!a[e].name)&&(GLM.$DEBUG&&
...
var f=c.$.identity.length;d=d||f;for(var g=function(a){GLM.$DEBUG&&GLM.$outer.console.debug("CACHEDBG: "+a)},h=0;h<d;h++)(function(d){var h=e&&e+d,i=d*f;Object.defineProperty(a,d,{configurable:!0,enumerable:!0,set:function(e){if(e instanceof c)this.elements.set(e.elements,i);else if(e&&e.length===f)this.elements.set(e,i);else throw new GLM.GLMJSError("unsupported argtype to "+(a&&a.$type)+"["+d+"] setter: "+[typeof e,e]);},get:function(){if(e){if(this[h])return d||g("cache hit "+h),this[h];d||g("cache miss "+
h)}var a,b=new c(a=GLM.$subarray(this.elements,i,i+f));if(b.elements!==a)throw new GLM.GLMJSError("v.elements !== t");e&&Object.defineProperty(this,h,{configurable:!0,enumerable:!1,value:b});return b}})})(h)};GLM.$partition(GLM.mat4.prototype,GLM.vec4,4,"_cache_");GLM.$partition(GLM.mat3.prototype,GLM.vec3,3,"_cache_")})();
