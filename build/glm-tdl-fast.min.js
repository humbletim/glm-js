...
var f=c.$.identity.length;d=d||f;for(var h=function(a){GLM.$DEBUG&&GLM.$outer.console.debug("CACHEDBG: "+a)},g=0;g<d;g++)(function(d){var g=e&&e+d,i=d*f;Object.defineProperty(a,d,{configurable:!0,enumerable:!0,set:function(e){if(e instanceof c)this.elements.set(e.elements,i);else if(e&&e.length===f)this.elements.set(e,i);else throw new GLM.GLMJSError("unsupported argtype to "+(a&&a.$type)+"["+d+"] setter: "+[typeof e,e]);},get:function(){if(e){if(this[g])return d||h("cache hit "+g),this[g];d||h("cache miss "+
