...
tdl.math.installErrorCheckFreeFunctions=function(){for(var a in tdl.math.errorCheckFree)tdl.math[a]=tdl.math.errorCheckFree[a]};tdl.math.installRowMajorFunctions();tdl.math.installErrorCheckFunctions();GLMJS_PREFIX="glm-js: ";function GLMJSError(a){var b;a:{try{generror_()}catch(c){b=c.stack.split(/\n/)[4];break a}b=void 0}this.e=b;this.toString=function(){return"[GLMJSError "+GLMJS_PREFIX+a+"]"+this.e};generatedError.prototype.message=a;GLM.$DLL.console.warn(a)}function generatedError(){}
generatedError.prototype=Error();GLMJSError.prototype=new generatedError;$GLM_extern=function(a,b){b=b||a;return function(){GLM[b]=GLM.$functions[a]||GLM.$DLL[a];if(!GLM[b])throw new GLMJSError("$GLM_extern: unresolved external symbol: "+a);return GLM[b].apply(this,arguments)}};$GLM_intern=function(a,b){if(void 0===b&&"object"===typeof a)for(var c in a)$GLM_intern(c,a[c]);else return GLM.$DLL.console.debug("intern "+a,b&&(b.name||typeof b)),GLM.$DLL[a]=b};
GLM={version:"0.0.1",GLM_VERSION:95,$functions:{},$DLL:{console:{debug:function(){}||(console.debug?function(){console.debug([].slice.call(arguments).join(" "))}:function(){console.warn([].slice.call(arguments).join(" "))}),warn:function(){console.warn([].slice.call(arguments).join(" "))},info:function(){console.info([].slice.call(arguments).join(" "))},error:function(){console.error([].slice.call(arguments).join(" "))},write:function(a){try{console.write(a)}catch(b){this.debug(a)}}},vec3_eulerAngles:function(a){var b=
this.mat4_array_from_quat(a);a=b[0];var c=b[4],d=b[1],e=b[5],f=b[2],g=b[6],b=b[10],h=new glm.vec3;h.y=Math.asin(-glm.clamp(f,-1,1));0.99999>Math.abs(f)?(h.x=Math.atan2(g,b),h.z=Math.atan2(d,a)):(h.x=0,h.z=Math.atan2(-c,e));return h}},$intern:$GLM_intern,$extern:$GLM_extern,GLMJSError:GLMJSError,_radians:function(a){return a*Math.PI/180},_degrees:function(a){return 180*a/Math.PI},normalize:$GLM_extern("normalize"),inverse:$GLM_extern("inverse"),length:$GLM_extern("length"),length2:$GLM_extern("length2"),
transpose:$GLM_extern("transpose"),mix:$GLM_extern("mix"),rotate:function(a,b,c){return a.mul(GLM.$DLL.mat4_angleAxis(b,c))},scale:function(a,b){return a.mul(GLM.$DLL.mat4_scale(b))},translate:function(a,b){return a.mul(GLM.$DLL.mat4_translation(b))},perspective:function(a,b,c,d){return GLM.$DLL.mat4_perspective(a,b,c,d)},eulerAngles:function(a){return GLM.$DLL.vec3_eulerAngles(a)},angleAxis:function(a,b){return GLM.$DLL.quat_angleAxis(a,b)},make_vec2:function(a){return new GLM.vec2([].slice.call(a,
0,2))},make_vec3:function(a){return new GLM.vec3([].slice.call(a,0,3))},make_vec4:function(a){return new GLM.vec4([].slice.call(a,0,4))},make_quat:function(a){return new GLM.quat([].slice.call(a,0,4))},make_mat3:function(a){return new GLM.mat3([].slice.call(a,0,9))},make_mat4:function(a){return new GLM.mat4([].slice.call(a,0,16))},toMat4:function(a){return new GLM.mat4(a)},FAITHFUL:!0,to_string:function(a){try{var b=a.$type||typeof a;if(!GLM[b])throw new GLMJSError("unsupported argtype to GLM.to_string: "+
[a,b]);if(!GLM[b].$)throw new GLMJSError("missing .$... GLM.to_string: "+[a,b]);return GLM.FAITHFUL?GLM[b].$.to_string(a).replace(/[\t\n]/g,""):GLM[b].$.to_string(a)}catch(c){GLM.$DLL.console.error("to_string error: ",b,a+"",c)}},$to_array:function(a){return[].slice.call(a.elements)},$sizeof:function(a){return a.BYTES_PER_ELEMENT},clamp:function(a,b,c){return a<b?b:a>c?c:a},max:function(a,b){return Math.max(a,b)},min:function(a,b){return Math.min(a,b)},sign:Math.sign||function(a){return 0<a?1:0>a?
-1:0},epsilon:function(){return 1E-6},FIXEDPRECISION:6,$toString:function(a,b,c){try{var d="";c.map(function(a){return b[d=a].toFixed(0)})}catch(e){throw GLM.$DLL.console.error("$toString error",a,b,d),new GLMJSError(e);}return[a,"(",c.map(function(a){return b[a].toFixed(GLM.FIXEDPRECISION)}).join(", "),")"].join("")}};
var GLM_template=GLM.$template={jstypes:{get:function(a){return null===a?"null":void 0===a?a+"":a.$type||GLM_template.jstypes[typeof a]||GLM_template.jstypes[a+""]||"<unknown "+[typeof a,a]+">"},number:"float","[object Float32Array]":"Float32Array"},"<T>":function(a,b){var c=function(c){var e=[c.$type||GLM_template.jstypes[typeof c]||"null"];if(!a[e])throw new GLMJSError("unsupported argtype to GLM."+b+"<T>: "+[e||typeof c]);return a[e](c)};c["<T>"]=c.$template=a;return c},"<T,V,n>":function(a,b){var c=
function(c,e,f){this.$type&&(f=e,e=c,c=this);var g=[c.$type||GLM_template.jstypes[typeof e],e.$type||GLM_template.jstypes[typeof e]||GLM_template.jstypes[e+""]||"<unknown "+e+">"];if(!a[g])throw new GLMJSError("unsupported argtype to "+b+"<T,V,n>: ["+g+"] :: "+[].slice.call(arguments).map(GLM_template.jstypes.get)+" // "+Object.keys(a).join("||"));if("number"!==typeof f)throw new GLMJSError(b+"<T,V,n>: unsupported n: "+f);return a[g](c,e,f)};c.sig="<T,V,n>";c.$template=a;return c},"<T,V>":function(a,
b){var c=function(c,e){this.$type&&(e=c,c=this);var f=[c.$type||GLM_template.jstypes[typeof e],e.$type||GLM_template.jstypes[typeof e]||GLM_template.jstypes[e+""]||"<unknown "+e+">"];if(!a[f])throw new GLMJSError("unsupported argtype to "+b+"<T,V>: ["+f+"] :: "+[].slice.call(arguments).map(GLM_template.jstypes.get));return a[f](c,e)};c.sig="<T,V>";c.$template=a;return c},override:function(a,b,c,d){GLM.$DLL.console.debug("override",a,b,c.op||"");if(!d)throw Error('unspecified target group (expected override(<TV>, "p", {TSP}, ret={GROUP}))');
var e=d[b]&&d[b];d[b]=GLM_template[a](GLM_template.denify(c),b);d[b].op=c.op;if(e){if(e.op!==d[b].op)throw Error("mismatch merging existing override:p="+[b,e.op,"||"+Object.keys(e.$template).join("||")]);for(var f in e.$template)f in d[b].$template||(GLM.$DLL.console.debug("carrying-forward: ",b,f),d[b].$template[f]=e.$template[f])}return d},_override:function(a,b,c){for(var d in b)this.override(a,d,b[d],c);return c},operations:function(a){return this._override("<T,V>",a,GLM.$functions)},calculators:function(a){return this._override("<T>",
a,GLM.$functions)},functions:function(a){return this._override("<T,V,n>",a,GLM.$functions)},denify:function(a){for(var b in a)if(/vec<N>/.test(b)){var c=a[b];delete a[b];[2,3,4].forEach(function(d){var e=b.replace(/<N>/g,d);e in a||(a[e]=eval(("1,"+c).replace(/N/g,d)))})}return a},GLMType:function(a,b){var c=b.identity.length,d=function(e){var f=typeof e+arguments.length,g=b[f];if(!g)throw new GLMJSError("no template found for "+a+".$."+f);if(this instanceof d)e instanceof Float32Array?(e.length>
c&&(e=e.subarray(0,c)),this.elements=e):(this.elements=new Float32Array(c)).set(g.apply(b,arguments));else return new d(g.apply(b,arguments))};d.$=b;d.componentLength=c;d.BYTES_PER_ELEMENT=c*Float32Array.BYTES_PER_ELEMENT;d.toString=function(){return"function GLM."+a+"(){ [ GLMType ] }"};d.prototype={$type:a,$typeName:b.name||"<"+a+">",$len:c,constructor:d,__proto__:5,clone:function(){return new d(this)},toString:function(){return b.to_string(this)},byteLength:d.BYTES_PER_ELEMENT,componentLength:d.componentLength,
get address(){var a=this.elements.byteOffset.toString(16);return"0x00000000".substr(0,10-a.length)+a}};return d}};GLM.$template.functions({mix:{"float,float":function(a,b,c){return b*c+a*(1-c)},"vec<N>,vec<N>":function(a,b,c){if(void 0===c)throw Error("glm.mix<vecN,vecN>(v,n,rt) requires 3 arguments");a=glm.$to_array(a);b=glm.$to_array(b);var d=1-c;return new glm.vecN(a.map(function(a,f){return b[f]*c+a*d}))}}});
...
GLM.to_glsl=GLM.$template.calculators({to_glsl:{"vec<N>":function(a){for(var b=GLM.$to_array(a);b.length&&b[b.length-2]===b[b.length-1];)b.pop();return a.$type+"("+b+")"},uvec4:function(a){return this.vec4(a)},quat:function(a){return 0===a.x+a.y+a.z?"quat("+a.w+")":"quat("+GLM.$to_array(a)+")"},mat3:function(a){a=GLM.$to_array(a);switch(a.reduce(function(a,c){return a+c},0)){case 3*a[0]:return"mat3("+a[0]+")";case 0:return"mat3(0)";case 3:if(4===a[0]+a[4]+a[7]+a[10])return"mat3(1)"}return"mat3("+
a+")"},mat4:function(a){a=GLM.$to_array(a);switch(a.reduce(function(a,c){return a+c},0)){case 4*a[0]:return"mat4("+a[0]+")";case 0:return"mat4(0)";case 4:if(4===a[0]+a[5]+a[10]+a[15])return"mat4(1)"}return"mat4("+a+")"}}}).to_glsl;GLM.from_glsl=function(a){if(GLM.from_glsl.shorthands[a])return GLM.from_glsl.shorthands[a]();a._&&a._.replace(/^glm\.(u?vec4|quat|mat4|mat3)\./,function(b,c){"quat"===c?glm[c]().elements.set([a.x,a.y,a.z,a.w]):glm[c]().copy(a)});throw Error("unrecognized json: "+a);};
...
GLM.$template.override("<T,V>","copy",{op:"=","mat4,mat4":function(a,b){a.elements.set(b.elements);return a},"quat,quat":function(a,b){a.elements.set(b.elements)},"vec<N>,vec<N>":function(a,b){a.elements.set(b.elements)}},GLM.$functions);GLM.string={$typeName:"string",$:{to_string:function(a){return a}}};GLM.number={$typeName:"float",$:{to_string:function(a){return GLM.$toString("float",{value:a},["value"])}}};
...
GLM.quat=GLM_template.GLMType("quat",{identity:[0,0,0,1],undefined0:function(){return this.identity},number1:function(a){if(1!==a)throw Error("only quat(1) syntax supported for quat(number1 args)...");return this.identity},number4:function(a,b,c,d){return[b,c,d,a]},object1:function(a){if(a instanceof GLM.mat4)return GLM.$DLL.quat_array_from_mat4(a);if(4===a.length)return a;if(a instanceof GLM.quat||"w"in a&&"x"in a)return[a.x,a.y,a.z,a.w];throw new GLMJSError("unrecognized object passed to GLM.quat.object1: "+
[a,a.$type,typeof a,a.constructor]);},to_string:function(a){a=GLM.degrees(GLM.eulerAngles(a));return GLM.$toString("<quat>"+a.$typeName,a,["x","y","z"])}});
...
"b"]);b(GLM.vec4,["x","y","z","w"]);b(GLM.vec4,["r","g","b","a"]);b(GLM.quat,["x","y","z","w"]);[2,3,4].forEach(function(a){a=GLM["vec"+a];b(a,a.$.identity.map(function(a,b){return b}))});var c=Float32Array.BYTES_PER_ELEMENT;GLM.$partition=function(a,b,f){var g=b.$.identity.length;f=f||g;GLM.$DLL.console.info("GLM.$partition",[g,f].join("x"));"elements"in a||void 0===f&&GLM.$DLL.console.warn("GLM.$partition will expects this.elements to be a Float32Array...");for(var h=0;h<f;h++)(function(f){var h=
f*c*g,i="_cached_"+f;Object.defineProperty(a,f,{configurable:!0,enumerable:!0,set:function(c){if(c instanceof b)return this[f].elements.set(c.elements);if(c.length===g)return this[f].elements.set(c);throw new GLMJSError("unsupported argtype to "+a.$type+"["+f+"] setter: "+[typeof c,c]);},get:function(){if(this[i])return f||GLM.$DLL.console.debug("CACHEDBG: cache hit "+i),Object.defineProperty(this,f,{value:this[i]}),this[i];f||GLM.$DLL.console.debug("CACHEDBG: cache miss "+i);Object.defineProperty(this,
i,{configurable:!0,enumerable:!1,value:new b(new Float32Array(this.elements.buffer,this.elements.byteOffset+h))});return this[i]}})})(h)};GLM.$partition(GLM.mat4.prototype,GLM.vec4,4);GLM.$partition(GLM.mat3.prototype,GLM.vec3,3)})();GLM.$dumpTypes=function(a){for(var b in GLM)GLM[b].componentLength&&a("GLM."+b,JSON.stringify({"#type":GLM[b].prototype.$typeName,"#floats":GLM[b].componentLength,"#bytes":GLM[b].BYTES_PER_ELEMENT}))};
GLM.init=function(a,b){b&&(GLMJS_PREFIX=b);var c=function(a){GLM.$DLL.console.write("\u00e2\u009c\u0094 "+a);try{"node"===process.title&&GLM.$DLL.console.write("\n")}catch(b){}};try{c("GLM-js: ENV: "+_ENV._VERSION)}catch(d){}c("GLM-JS: initializing: "+JSON.stringify(a,0,2));c(JSON.stringify({functions:Object.keys(GLM.$functions)}));GLM.$symbols=[];for(var e in GLM)if("function"===typeof GLM[e]&&(/^[a-z]/.test(e)&&GLM.$symbols.push(e),"$"in GLM[e]))for(var f in GLM.$functions){var g=GLM.$functions[f];
g.op&&(GLM[e].prototype[f]=g,GLM[e].prototype[g.op]=g)}c("GLM-JS: "+GLM.version+" emulating GLM_VERSION="+GLM.GLM_VERSION+" vendor_name="+a.vendor_name+" vendor_version="+a.vendor_version);glm.vendor=a};
GLM.using_namespace=function(a){console.warn("GLM.using_namespace munges globals; it should not be used!");var b=[],c=GLM.$symbols,d=c.filter(function(a){return eval("1, 'undefined' !== typeof "+a)});c.map(function(a){var c="GLM.using_namespace."+a+"=undefined;delete GLM.using_namespace."+a+";";try{GLM.using_namespace[a]=eval("1,"+a),b.push(new Function("",a+"=GLM.using_namespace."+a+";"+c))}catch(d){b.push(new Function("",a+"=undefined;delete "+a+";"+c))}eval(a+"=GLM."+a)});a();b.map(function(a){a()});
a=c.filter(function(a){return eval("1, 'undefined' !== typeof "+a)});if(0!==d.length+a.length)throw Error(vec3+":"+JSON.stringify({before:d,after:a,usn:Object.keys(GLM.using_namespace)}));};try{module.exports=GLM}catch(e$$20){}try{tdl.fast.exists}catch(e$$21){tdl.fast.exists}glm=GLM;var DLL=glm.$DLL["tdl-fast.js"]={vendor_name:"tdl-fast.js",vendor_version:"2009?",_name:"glm.tdl-fast.js",_version:"0.0.0"};
DLL.$functions=function(){return{mat4_perspective:function(a,b,c,d){return new glm.mat4(tdl.fast.matrix4.perspective(new Float32Array(16),a,b,c,d))},mat4_angleAxis:function(a,b){return new glm.mat4(tdl.fast.matrix4.axisRotation(new Float32Array(16),b,a))},quat_angleAxis:function(a,b){var c=tdl.quaternions.axisRotation(b.elements,a);return new glm.quat(c)},mat4_array_from_quat:function(a){return tdl.quaternions.quaternionToRotation(a.elements)},quat_array_from_mat4:function(a){return tdl.quaternions.rotationToQuaternion(a.elements)}}}();
glm.$template.operations({mul:{op:"*","quat,vec<N>":function(a,b){return glm.toMat4(a).mul(b)},"vec<N>,quat":function(a,b){return glm.toMat4(b).mul(a)},"vec<N>,float":function(a,b){return new glm.vecN(tdl.fast.mulVectorScalar(new Float32Array(N),a.elements,b))},"mat4,vec3":function(a,b){return new glm.vec3(this["mat4,vec4"](a,new glm.vec4(b,1)).elements)},"mat4,vec4":function(a,b){return new glm.vec4(tdl.fast.rowMajor.mulVectorMatrix4(new Float32Array(4),b,a.elements))},"mat4,mat4":function(a,b){return new glm.mat4(tdl.fast.rowMajor.mulMatrixMatrix4(new Float32Array(16),
a.elements,b.elements))}},mul_eq:{op:"*=","vec<N>,float":function(a,b){tdl.fast.mulVectorScalar(a.elements,a.elements,b);return a}}});
glm.$template.functions({mix:{"quat,quat":function(a,b,c){a=a.elements;b=b.elements;var d=new glm.quat(new Float32Array(4)),e=d.elements,f=a[0],g=a[1],h=a[2],k=a[3],j=b[0],i=b[1],l=b[2];b=b[3];var m=f*j+g*i+h*l+k*b,n;if(1<=Math.abs(m))return e!==a&&(e[0]=f,e[1]=g,e[2]=h,e[3]=k),d;a=Math.acos(m);n=Math.sqrt(1-m*m);m=Math.sin((1-c)*a)/n;c=Math.sin(c*a)/n;e[0]=f*m+j*c;e[1]=g*m+i*c;e[2]=h*m+l*c;e[3]=k*m+b*c;return d}}});
glm.$template.calculators({normalize:{"vec<N>":function(a){return new glm.vecN(tdl.fast.normalize(new Float32Array(N),a.elements))},quat:function(a){return new glm.quat(tdl.quaternions.normalize(a.elements))}},length:{"vec<N>":function(a){return tdl.math.length(a.elements)},quat:function(a){return tdl.quaternions.length(a.elements)}},length2:{"vec<N>":function(a){return tdl.math.lengthSquared(a.elements)},quat:function(a){return tdl.quaternions.lengthSquared(a.elements)}},inverse:{quat:function(a){return new glm.quat(tdl.quaternions.inverse(a.elements))},
mat4:function(a){return new glm.mat4(tdl.fast.inverse4(new Float32Array(16),a.elements))}},transpose:{mat4:function(a){return new glm.mat4(tdl.fast.transpose4(new Float32Array(16),a.elements))}}});glm.$intern(DLL.$functions);glm.init({vendor_name:DLL.vendor_name},"glm-js[tdl-fast]: ");try{module.exports=glm}catch(e$$22){};
