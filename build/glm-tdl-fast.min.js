...
tdl.math.installErrorCheckFreeFunctions=function(){for(var a in tdl.math.errorCheckFree)tdl.math[a]=tdl.math.errorCheckFree[a]};tdl.math.installRowMajorFunctions();tdl.math.installErrorCheckFunctions();GLMJS_PREFIX="glm-js: ";function createErrorType(a,b){function c(c){this.name=a;Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=Error().stack;this.message=c;b&&b.apply(this,arguments)}c.prototype=Error();c.prototype.name=a;return c.prototype.constructor=c}
var GLMJSError=createErrorType("GLMJSError");$GLM_extern=function(a,b){b=b||a;return function(){GLM[b]=GLM.$functions[a]||GLM.outer[a];if(!GLM[b])throw new GLMJSError("$GLM_extern: unresolved external symbol: "+a);return GLM[b].apply(this,arguments)}};$GLM_intern=function(a,b){if(void 0===b&&"object"===typeof a)for(var c in a)$GLM_intern(c,a[c]);else return GLM.outer.console.debug("intern "+a,b&&(b.name||typeof b)),GLM.outer[a]=b};
...
"<T,V,n>";c.$template=a;return c},"<T,V>":function(a,b){function c(c,f,g,h,k){this.$type&&(k=h,h=g,g=f,f=c,c=this);var i=f&&[c.$type||d[typeof f],f.$type||d[typeof f]||d[f+""]||"<unknown "+f+">"];if(!a[i])throw GLM_template._genArgError(a,b,i,[].slice.call(arguments));return a[i](c,f,g,h,k)}var d=GLM_template.jstypes;a.sig="<T,V>";c.$template=a;return c},override:function(a,b,c,d){GLM.outer.console.debug("override",a,b,c.op||"");if(!d)throw Error('unspecified target group (expected override(<TV>, "p", {TSP}, ret={GROUP}))');
...
"b"]);b(GLM.vec4,["x","y","z","w"]);b(GLM.vec4,["r","g","b","a"]);b(GLM.quat,["x","y","z","w"]);Object.defineProperty(GLM.quat.prototype,"_x",{get:function(){throw Error("erroneous quat._x access");}});[2,3,4].forEach(function(a){a=GLM["vec"+a];b(a,a.$.identity.map(function(a,b){return b}))});var c=Float32Array.BYTES_PER_ELEMENT;GLM.$partition=function(a,b,f,g){if(void 0===f)throw new GLMJSError("nrows is undefined");var h=b.$.identity.length;f=f||h;for(var k=c*h,i=0;i<f;i++)(function(c){var f=c*
k,i=g&&g+c,n=c*h;Object.defineProperty(a,c,{configurable:!0,enumerable:!0,set:function(f){console.warn("local elements !!SET"+f);if(f instanceof b)this.elements.set(f.elements,n);else if(f&&f.length===h)this.elements.set(f,n);else throw new GLMJSError("unsupported argtype to "+(a&&a.$type)+"["+c+"] setter: "+[typeof f,f]);},get:function(){if(g){if(this[i])return c||GLM.outer.console.debug("CACHEDBG: cache hit "+i),Object.defineProperty(this,c,{configurable:!0,enumerable:!1,value:this[i]}),this[i];
...
a=c.filter(function(a){return eval("1, 'undefined' !== typeof "+a)});if(d.length!==a.length)throw Error(JSON.stringify({before:d,after:a,usn:Object.keys(GLM.using_namespace)}));};try{module.exports=GLM}catch(e$$18){}tdl.fast.exists;glm=GLM;var DLL=glm.outer["tdl-fast.js"]={vendor_name:"tdl-fast.js",vendor_version:"2009?",_name:"glm.tdl-fast.js",_version:"0.0.0"};
DLL.$functions={mat4_perspective:function(a,b,c,d){return new glm.mat4(tdl.fast.matrix4.perspective(new Float32Array(16),a,b,c,d))},mat4_angleAxis:function(a,b){return new glm.mat4(tdl.fast.matrix4.axisRotation(new Float32Array(16),b.elements,a))},quat_angleAxis:function(a,b){var c=tdl.quaternions.axisRotation(b.elements,a);return new glm.quat(c)},mat4_translation:function(a){return new glm.mat4(tdl.fast.matrix4.translation(new Float32Array(16),a.elements))},mat4_scale:function(a){return new glm.mat4(tdl.fast.matrix4.scaling(new Float32Array(16),
a.elements))},mat4_array_from_quat:function(a){return tdl.quaternions.quaternionToRotation(a.elements)},quat_array_from_mat4:function(a){return tdl.quaternions.rotationToQuaternion(a.elements)}};
glm.$template.operations({mul:{op:"*",_mulQuatQuat:tdl.quaternions.mulQuaternionQuaternion,"quat,quat":function(a,b){return new glm.quat(this._mulQuatQuat(a.elements,b.elements))},"quat,vec<N>":function(a,b){return glm.toMat4(a).mul(b)},"vec<N>,quat":function(a,b){return glm.toMat4(b).mul(a)},_mulVecSca:tdl.fast.mulVectorScalar,"vec<N>,float":function(a,b){return new glm.vecN(this._mulVecSca(new Float32Array(N),a.elements,b))},"mat4,vec3":function(a,b){b=new glm.vec4(b,1);var c=this["mat4,vec4"](a,
b);return new glm.vec3(c)},_mulVecMat4:tdl.fast.rowMajor.mulVectorMatrix4,"mat4,vec4":function(a,b){return new glm.vec4(this._mulVecMat4(new Float32Array(4),b.elements,a.elements))},_mulMatMat:tdl.fast.columnMajor.mulMatrixMatrix4,"mat4,mat4":function(a,b){return new glm.mat4(this._mulMatMat(new Float32Array(16),a.elements,b.elements))}},mul_eq:{op:"*=","vec<N>,float":function(a,b){tdl.fast.mulVectorScalar(a.elements,a.elements,b);return a},_mulMatMat:tdl.fast.columnMajor.mulMatrixMatrix4,"mat4,mat4":function(a,
b){this._mulMatMat(a.elements,a.elements,b.elements);return a},_mulQuatQuat:tdl.quaternions.mulQuaternionQuaternion,"quat,quat":function(a,b){a.elements.set(this._mulQuatQuat(a.elements,b.elements));return a}}});
...
mat4:function(a){return new glm.mat4(tdl.fast.inverse4(new Float32Array(16),a.elements))}},transpose:{mat4:function(a){return new glm.mat4(tdl.fast.transpose4(new Float32Array(16),a.elements))}}});glm.$intern(DLL.$functions);glm.init({vendor_name:DLL.vendor_name},"glm-js[tdl-fast]: ");try{module.exports=glm}catch(e$$19){};
