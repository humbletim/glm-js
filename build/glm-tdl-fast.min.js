...
a.prototype.$type:!1},$getGLMType:function(a){return"$type"in a&&~GLM.$types.indexOf(a.$type)?GLM[a.$type]:!1},$isGLMObject:function(a){return~GLM.$types.indexOf(a&&a.$type)?a.$type:!1},$to_array:function(a){return[].slice.call(a.elements)},$to_json:function(a,b,c){"$type"in this&&(c=b,b=a,a=this);return JSON.stringify(GLM.$to_object(a),b,c)},$inspect:function(a){"$type"in this&&(a=this);return GLM.$to_json(a,null,2)},$sizeof:function(a){return a.BYTES_PER_ELEMENT},_clamp:function(a,b,c){return a<
b?b:a>c?c:a},max:function(a,b){return Math.max(a,b)},min:function(a,b){return Math.min(a,b)},_sign:function(a){return 0<a?1:0>a?-1:+a},epsilon:function(){return 1E-6},FIXEDPRECISION:6,$toString:function(a,b,c,d){d=void 0===d?GLM.FIXEDPRECISION:d;if(!c||!c.map)throw Error("unsupported argtype to $toString(..,..,props="+typeof c+")");try{var e="";c.map(function(a){a=b[e=a];if(!a.toFixed)throw Error("!toFixed in w");return a.toFixed(0)})}catch(f){throw GLM.$DEBUG&&GLM.$outer.console.error("$toString error",
a,typeof b,Object.prototype.toString.call(b),e),GLM.$DEBUG&&glm.$log("$toString error",a,typeof b,Object.prototype.toString.call(b),e),new GLMJSError(f);}return[a,"(",c.map(function(a){return b[a].toFixed(d)}).join(", "),")"].join("")}};GLM.sign=Math.sign||GLM._sign;
...
b){function c(c,f,g,h,k){"$type"in this&&(k=h,h=g,g=f,f=c,c=this);var i=[c&&c.$type||d[typeof f],f&&f.$type||d[typeof f]||d[f+""]||f instanceof Array&&"array"+f.length+""||"<unknown "+f+">"];if(!a[i])throw GLM_template._genArgError(a,b,i,[c,f,g,h,k]);return a[i](c,f,g,h,k)}var d=GLM_template.jstypes;a.$sig="<T,V>";c.$template=a;return c},override:function(a,b,c,d){GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: ",a,b,c.$op?'$op: ["'+c.$op+'"]':"");if(!d)throw Error("unspecified target group "+
d+' (expected override(<TV>, "p", {TSP}, ret={GROUP}))');var e=d[b]&&d[b];d[b]=GLM_template[a](GLM_template.deNify(c,b),b);d[b].$op=c.$op;if(e){if(e.$op!==d[b].$op)throw Error('glm.$template.override: mismatch merging existing override: .$op "'+[e.$op,"!=",d[b].$op].join(" ")+'"  p='+[b,e.$op,d[b].$op,"||"+Object.keys(e.$template).join("||")]);var f=[],g;for(g in d[b].$template)g in e.$template||GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+g+" overlayed");for(g in e.$template)g in
d[b].$template||(GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+g+" carried-forward"),f.push(g),d[b].$template[g]=e.$template[g]);GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+Object.keys(d[b].$template).filter(function(a){return!~a.indexOf("$")}).map(function(a){return!~f.indexOf(a)?"*"+a+"*":a}).join(" | "))}else GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+Object.keys(d[b].$template).filter(function(a){return!~a.indexOf("$")}).map(function(a){return"*"+
a+"*"}).join(" | "));return d},_override:function(a,b,c){for(var d in b)this.override(a,d,b[d],c);return c},extend:function(a,b){[].slice.call(arguments,1).forEach(function(b){for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d])});return a},operations:function(a){return this._override("<T,V>",a,GLM.$outer.functions)},calculators:function(a){return this._override("<T>",a,GLM.$outer.functions)},varargs_functions:function(a){return this._override("<T,...>",a,GLM.$outer.functions)},functions:function(a){return this._override("<T,V,n>",
a,GLM.$outer.functions)},deNify:function(a,b){b=(b||"").replace(/[^$a-zA-Z0-9_]/g,"_");var c={vec:[2,3,4],mat:[3,4]},d;for(d in a)d.replace(/(vec|mat)<N>/,function(e,f){var g=a[d];delete a[d];c[f].forEach(function(c){var e=d.replace(/<N[*]N>/g,c*c).replace(/<N>/g,c);if(!(e in a)){var f=(b+"_"+e).replace(/[^$a-z0-9_]/g,"_");a[e]=(new Function("","return "+(g+"").replace(/^function\s*\(/,"function "+f+"(").replace(/N[*]N/g,c*c).replace(/N/g,c)))()}})});return a},GLMType:function(a,b){var c=b.identity.length,
d=function(e){var f=typeof e+arguments.length,g=b[f];if(!g)throw new GLMJSError("no template found for "+a+".$."+f);if(this instanceof d){if(e instanceof Float32Array){if(e.length>c)throw glm.$outer.console.error(a+" elements size mismatch: "+["wanted:"+c,"handed:"+e.length]),f=e.subarray(0,c),Error(a+" elements size mismatch: "+["wanted:"+c,"handed:"+e.length,,"correctable?:"+f.length]);elements=e}else(elements=new Float32Array(c)).set(g.apply(b,arguments));Object.defineProperty(this,"elements",
{enumerable:!1,configurable:!0,value:elements})}else return new d(g.apply(b,arguments))};b.components=b.components?b.components.map(function(a){return"string"===typeof a?a.split(""):a}):[];d.$=b;d.componentLength=c;d.BYTES_PER_ELEMENT=c*Float32Array.BYTES_PER_ELEMENT;d.toString=function(){return"function GLM."+a+"(){ [ GLMType ] }"};d.prototype={$type:a,$type_name:b.name||"<"+a+">",$components:b.components[0],$len:c,constructor:d,clone:function(){return new d(this)},toString:function(){return GLM.$to_string(this)},
byteLength:d.BYTES_PER_ELEMENT,componentLength:d.componentLength};Object.defineProperty(d.prototype,"address",{get:function(){var a=this.elements.byteOffset.toString(16);return"0x00000000".substr(0,10-a.length)+a}});return d}};
...
w:a.w}},quat:function(a){return{w:a.w,x:a.x,y:a.y,z:a.z}},mat3:function(a){return{"0":this.vec3(a[0]),1:this.vec3(a[1]),2:this.vec3(a[2])}},mat4:function(a){return{"0":this.vec4(a[0]),1:this.vec4(a[1]),2:this.vec4(a[2]),3:this.vec4(a[3])}}},$to_glsl:{"vec<N>":function(a){for(var b=GLM.$to_array(a);b.length&&b[b.length-2]===b[b.length-1];)b.pop();return a.$type+"("+b+")"},uvec4:function(a){return this.vec4(a)},quat:function(a){return 0===a.x+a.y+a.z?"quat("+a.w+")":"quat("+GLM.$to_array(a)+")"},mat3:function(a){a=
GLM.$to_array(a);return a.reduce(function(a,c){return a+c},0)===3*a[0]?"mat3("+a[0]+")":"mat3("+a+")"},mat4:function(a){a=GLM.$to_array(a);return a.reduce(function(a,c){return a+c},0)===4*a[0]?"mat4("+a[0]+")":"mat4("+a+")"}},$from_glsl:{string:function(a){var b;a.replace(/^(\w+)\(([-.0-9ef, ]+)\)$/,function(a,d,e){b=glm[d].apply(glm,e.split(",").map(parseFloat))});return b}}}));
GLM.$to_string=GLM.$template.varargs_functions({$to_string:{"float":function(a,b){return GLM.$toString("float",{value:a},["value"],b)},string:function(a){return a},"vec<N>":function(a,b){return GLM.$toString(a.$type_name,a,a.$components,b)},uvec4:function(a){return a.$type_name+"("+glm.$to_array(a)+")"},"mat<N>":function(a,b){var c=[0,1,2,3].slice(0,N).map(function(b){return a[b]}).map(function(a){return GLM.$toString("\t",a,a.$components,b)});return a.$type_name+"(\n"+c.join(", \n")+"\n)"},quat:function(a,
b){a=GLM.degrees(GLM.eulerAngles(a));return GLM.$toString("<quat>"+a.$type_name,a,["x","y","z"],b)}}}).$to_string;
...
(function(){var a=function(a,b,e){var f=[0,1,2,3].map(function(a){return{enumerable:e,get:function(){return this.elements[a]},set:function(b){this.elements[a]=b}}});b.forEach(function(b,d){Object.defineProperty(a.prototype,b,f[d])});if(isNaN(b[0])&&!/^_/.test(b[0])){do(function(b,d,e){Object.defineProperty(a.prototype,b,{enumerable:!1,get:function(){return new GLM[d](this.elements.subarray(0*e,1*e))},set:function(a){return(new GLM[d](this.elements.subarray(0*e,1*e)))["="](a)}})})(b.join(""),a.prototype.$type.replace(/[1-9]$/,
b.length),b.length);while(b[1]!=b.pop())}};a(GLM.vec2,["x","y"],!0);a(GLM.vec3,["x","y","z"],!0);a(GLM.vec3,["r","g","b"]);a(GLM.vec4,["x","y","z","w"],!0);a(GLM.vec4,["r","g","b","a"]);a(GLM.quat,["x","y","z","w"],!0);a(GLM.uvec4,["x","y","z","w"],!0);a(GLM.uvec4,["0","1","2","3"]);Object.defineProperty(GLM.quat.prototype,"_x",{get:function(){throw Error("erroneous quat._x access");}});[2,3,4].forEach(function(b){b=GLM["vec"+b];a(b,b.$.identity.map(function(a,b){return b}))});var b=Float32Array.BYTES_PER_ELEMENT;
GLM.$partition=function(a,d,e,f){if(void 0===e)throw new GLMJSError("nrows is undefined");var g=d.$.identity.length;e=e||g;for(var h=function(a){GLM.$DEBUG&&GLM.$outer.console.debug("CACHEDBG: "+a)},k=b*g,i=0;i<e;i++)(function(b){var e=b*k,i=f&&f+b,n=b*g;Object.defineProperty(a,b,{configurable:!0,enumerable:!0,set:function(e){if(e instanceof d)this.elements.set(e.elements,n);else if(e&&e.length===g)this.elements.set(e,n);else throw new GLMJSError("unsupported argtype to "+(a&&a.$type)+"["+b+"] setter: "+
[typeof e,e]);},get:function(){if(f){if(this[i])return b||h("cache hit "+i),Object.defineProperty(this,b,{configurable:!0,enumerable:!1,value:this[i]}),this[i];b||h("cache miss "+i)}var a,c=new d(a=new Float32Array(this.elements.buffer,this.elements.byteOffset+e,g));if(c.elements!==a)throw 5;f&&Object.defineProperty(this,i,{configurable:!0,enumerable:!1,value:c});return c}})})(i)};GLM.$partition(GLM.mat4.prototype,GLM.vec4,4,"_cache_");GLM.$partition(GLM.mat3.prototype,GLM.vec3,3,"_cache_")})();
GLM.$dumpTypes=function(a){for(var b in GLM)GLM[b].componentLength&&a("GLM."+b,JSON.stringify({"#type":GLM[b].prototype.$type_name,"#floats":GLM[b].componentLength,"#bytes":GLM[b].BYTES_PER_ELEMENT}))};
GLM.$init=function(a){a.prefix&&(GLMJS_PREFIX=a.prefix);var b=a.log||function(){};try{b("GLM-js: ENV: "+_ENV._VERSION)}catch(c){}b("GLM-JS: initializing: "+JSON.stringify(a,0,2));b(JSON.stringify({functions:Object.keys(GLM.$outer.functions)}));GLM.$outer.vec3_eulerAngles=GLM.$outer.vec3_eulerAngles||GLM.$outer._vec3_eulerAngles;GLM.$symbols=[];GLM.$types=[];for(var d in GLM)"function"===typeof GLM[d]&&(/^[a-z]/.test(d)&&GLM.$symbols.push(d),"$type"in GLM[d].prototype&&GLM.$types.push(d));GLM.$types.forEach(function(a){var b=
GLM[a].prototype.$type,c;for(c in GLM.$outer.functions){var d=GLM.$outer.functions[c];d.$op&&(GLM.$DEBUG&&GLM.$outer.console.debug("mapping operator<"+b+"> "+c+" / "+d.$op),GLM[a].prototype[c]=d,GLM[a].prototype[d.$op]=d)}});b("GLM-JS: "+GLM.version+" emulating GLM_VERSION="+GLM.GLM_VERSION+" vendor_name="+a.vendor_name+" vendor_version="+a.vendor_version);glm.vendor=a};
