...
GLM)throw new GLM.GLMJSError("... use glm.make_<type>() (not new glm.make<type>())");b=new Float32Array(b.buffer||b,c,a.componentLength);b=new Float32Array(b);return new a(b)},make_vec2:function(a,b){return GLM.$from_ptr.call(this,GLM.vec2,a,2===arguments.length?b:a.byteOffset)},make_vec3:function(a,b){return GLM.$from_ptr.call(this,GLM.vec3,a,2===arguments.length?b:a.byteOffset)},make_vec4:function(a,b){return GLM.$from_ptr.call(this,GLM.vec4,a,2===arguments.length?b:a.byteOffset)},make_quat:function(a,
...
a,typeof b,Object.prototype.toString.call(b),e),GLM.$DEBUG&&glm.$log("$toFixedString error",a,typeof b,Object.prototype.toString.call(b),e),new GLM.GLMJSError(f);}c=c.map(function(a){return b[a].toFixed(d)});return a+"("+c.join(", ")+")"}};GLM.sign=Math.sign||GLM._sign;
GLM.$GLMBaseType=function(){function a(a,c){var d=a.$||{};this.$type=c;this.$type_name=d.name||"<"+c+">";d.components&&(this.$components=d.components[0]);this.$len=this.components=a.componentLength;this.constructor=a;this.byteLength=a.BYTES_PER_ELEMENT;GLM.$types.push(c)}a.prototype={_clone:function(){return new this.constructor(this)},clone:function(){return new this.constructor(new this.elements.constructor(this.elements))},toString:function(){return GLM.$to_string(this)},inspect:function(){return GLM.$inspect(this)},
toJSON:function(){return GLM.$to_object(this)}};Object.defineProperty(a.prototype,"address",{get:function(){var a=this.elements.byteOffset.toString(16);return"0x00000000".substr(0,10-a.length)+a}});return a}();
var GLM_template=GLM.$template={_genArgError:function(a,b,c,d){~d.indexOf(void 0)&&(d=d.slice(0,d.indexOf(void 0)));var e=RegExp.prototype.test.bind(/^[^$_]/);return new GLM.GLMJSError("unsupported argtype to "+b+""+a.$sig+": [typ="+c+"] :: got arg types: "+d.map(GLM.$template.jstypes.get)+" // supported types: "+Object.keys(a).filter(e).join("||"))},jstypes:{get:function(a){return null===a?"null":void 0===a?"undefined":a.$type||GLM.$template.jstypes[typeof a]||GLM.$template.jstypes[a+""]||"<unknown "+
[typeof a,a]+">"},"0":"float",number:"float",string:"string","[object Float32Array]":"Float32Array","[object ArrayBuffer]":"ArrayBuffer","function":"function"},_add_overrides:function(a,b){for(var c in b)b[c]&&GLM[c].override(a,b[c])},_add_inline_override:function(a,b,c){this[b]=eval(GLM.$template._traceable("glm_"+a+"_"+b,c))();return this},_inline_helpers:function(a,b){return{$type:"built-in",$type_name:b,$template:a,F:a,dbg:b,override:this._add_inline_override.bind(a,b),link:function(c){var d=
a[c];d||(d=a[[c,"undefined"]]);if(!d)throw new GLM.GLMJSError("error linking direct function for "+b+"<"+c+"> or "+b+"<"+[c,void 0]+">");return/\bthis\./.test(d+"")?d.bind(a):d}}},"<T>":function(a,b){a.$sig="<T>";return this.slingshot(this._inline_helpers(a,b),eval(this._traceable("Tglm_"+b,function(b){this instanceof GLM.$GLMBaseType&&(b=this);var d=[b&&b.$type||GLM.$template.jstypes[typeof b]||"null"];if(!a[d])throw GLM.$template._genArgError(a,arguments.callee.dbg,d,[b]);return a[d](b)}))())},
"<T,...>":function(a,b){a.$sig="<T,...>";var c=GLM.$template.jstypes;return this.slingshot(this._inline_helpers(a,b),eval(this._traceable("Tdotglm_"+b,function(b){var e=__VA_ARGS__;this instanceof GLM.$GLMBaseType&&e.unshift(b=this);var f=[b&&b.$type||c[typeof b]||c.get(b)||"null"];if(!a[f])throw GLM.$template._genArgError(a,arguments.callee.dbg,f,e);return a[f].apply(a,e)}))())},"<T,V,n>":function(a,b){a.$sig="<T,V,n>";var c=GLM.$template.jstypes;return this.slingshot(this._inline_helpers(a,b),eval(this._traceable("TVnglm_"+
b,function(){var b=__VA_ARGS__;this instanceof GLM.$GLMBaseType&&b.unshift(this);var e=b[0],f=b[1],b=b[2],g=[e&&e.$type||c[typeof e]||c[e+""]||"<unknown "+e+">",f&&f.$type||c[typeof f]||c[f+""]||"<unknown "+f+">"];if(!a[g])throw GLM.$template._genArgError(a,arguments.callee.dbg,g,[e,f,b]);if("number"!==typeof b)throw new GLM.GLMJSError(arguments.callee.dbg+a.$sig+": unsupported n type: "+[typeof b,b]);return a[g](e,f,b)}))())},"<T,V>":function(a,b){a.$sig="<T,V>";var c=GLM.$template.jstypes,d=GLM.$GLMBaseType,
e=GLM.$template._genArgError;return this.slingshot(this._inline_helpers(a,b),eval(this._traceable("TVglm_"+b,function(){var b=__VA_ARGS__;this instanceof d&&b.unshift(this);var g=b[0],h=b[1],g=[g&&g.$type||c[typeof g],h&&h.$type||c[typeof h]||c[h+""]||Array.isArray(h)&&"array"+h.length+""||""+h+""];if(!a[g])throw e(a,arguments.callee.dbg,g,b);return a[g].apply(a,b)}))())},override:function(a,b,c,d){GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: ",a,b,c.$op?'$op: ["'+c.$op+'"]':"");
if(!d)throw Error("unspecified target group "+d+' (expected override(<TV>, "p", {TSP}, ret={GROUP}))');var e=d[b];if(e&&e.$op!==c.$op)throw Error('glm.$template.override: mismatch merging existing override: .$op "'+[e.$op,"!=",c.$op].join(" ")+'"  p='+[b,e.$op,c.$op,"||"+Object.keys(e.$template).join("||")]);var f=GLM.$template[a](GLM.$template.deNify(c,b),b);f.$op=c.$op;if(e){var g=[],h;for(h in f.$template)h in e.$template||(GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+
h+" overlayed"),e.$template[h]=f.$template[h]);Object.keys(e.$template).forEach(function(a){a in f.$template||(GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+a+" carried-forward"),g.push(a))});GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+Object.keys(d[b].$template).filter(function(a){return!~a.indexOf("$")}).map(function(a){return!~g.indexOf(a)?"*"+a+"*":a}).join(" | "))}else d[b]=f,GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+
b+" ... "+Object.keys(d[b].$template).filter(function(a){return!~a.indexOf("$")}).map(function(a){return"*"+a+"*"}).join(" | "));return d},_override:function(a,b,c){for(var d in b)this.override(a,d,b[d],c);return c},slingshot:function(){return this.extend.apply(this,[].reverse.call(arguments))},extend:function(a,b){[].slice.call(arguments,1).forEach(function(b){for(var d in b)b.hasOwnProperty(d)&&(a[d]=b[d])});return a},operations:function(a){return this._override("<T,V>",a,GLM.$outer.functions)},
calculators:function(a){return this._override("<T>",a,GLM.$outer.functions)},varargs_functions:function(a){return this._override("<T,...>",a,GLM.$outer.functions)},functions:function(a){return this._override("<T,V,n>",a,GLM.$outer.functions)},_tojsname:function(a){return(a||"_").replace(/[^$a-zA-Z0-9_]/g,"_")},_traceable:function(a,b){if("function"!==typeof b)throw new GLM.GLMJSError("_traceable expects tidy function as first arg "+b);if(!a)throw new GLM.GLMJSError("_traceable expects hint or what's the point"+
[b,a]);a=this._tojsname(a||"_traceable");b=(b+"").replace(/^(\s*var\s*(\w+)\s*=\s*)__VA_ARGS__;/mg,function(a,b,e){return b+"new Array(arguments.length);for(var I=0;I<varname.length;I++)varname[I]=arguments[I];".replace(/I/g,"__VA_ARGS__I").replace(/varname/g,e)});if(2===b.split(/^\s*function\b/).length)b=(function(){SRC;return HINT}+"").replace("HINT",a).replace("SRC",b.replace(/^function\s*\(/,"function "+a+"("));else throw new GLM.GLMJSError("expected singular anonymous function: "+[b,a]);return"1,"+
b},deNify:function(a,b){var c={vec:[2,3,4],mat:[3,4]},d=this._tojsname.bind(this),e;for(e in a){var f=!1;e.replace(/([vV]ec|[mM]at)(?:\w*)<N>/,function(g,h){f=!0;var k=a[e];delete a[e];c[h.toLowerCase()].forEach(function(c){var f=e.replace(/<N[*]N>/g,c*c).replace(/<N>/g,c);if(!(f in a)){var g=d("glm_"+b+"_"+f);a[f]=(new Function("","return "+(k+"").replace(/^function\s*\(/,"function "+g+"(").replace(/N[*]N/g,c*c).replace(/N/g,c)))()}})}.bind(this));!f&&("function"===typeof a[e]&&!a[e].name)&&(GLM.$DEBUG&&
GLM.$outer.console.debug("naming "+d(b+"_"+e)),a[e]=eval(this._traceable("glm_"+b+"_"+e,a[e]))())}return a},$_module_stamp:+new Date,GLMType:function(a,b){var c=b.identity.length;Object.keys(b).filter(function(a){return"function"===typeof b[a]&&!b[a].name}).map(function(c){var d=a+"_"+c;GLM.$DEBUG&&GLM.$outer.console.debug("naming $."+c+" == "+d,this._traceable(d,b[c]));b[c]=eval(this._traceable("glm_"+d,b[c]))()}.bind(this));var d=eval(this._traceable("glm_"+a+"$class",function(a){var b=d.$,c=d.prototype.$type,
h=__VA_ARGS__,k=typeof a+h.length,i=b[k];if(!i)throw new GLM.GLMJSError("no template found for "+c+".$."+k);if(this instanceof d){if(a instanceof Float32Array){if(a.length!=d.componentLength)throw GLM.$outer.console.error(c+" elements size mismatch: "+["wanted:"+d.componentLength,"handed:"+a.length]),b=a.subarray(0,d.componentLength),new GLM.GLMJSError(c+" elements size mismatch: "+["wanted:"+d.componentLength,"handed:"+a.length,"theoreticaly-correctable?:"+(b.length===d.componentLength)]);}else(a=
new Float32Array(d.componentLength)).set(i.apply(b,h));Object.defineProperty(this,"elements",{enumerable:!1,configurable:!0,value:a})}else return new d(i.apply(b,h))}))();b.components=b.components?b.components.map(function(a){return"string"===typeof a?a.split(""):a}):[];d.$=b;d.componentLength=c;d.BYTES_PER_ELEMENT=c*Float32Array.BYTES_PER_ELEMENT;d.prototype=new GLM.$GLMBaseType(d,a);return d}};
...
y:a.y,z:a.z}},uvec4:function(a){return{x:a.x,y:a.y,z:a.z,w:a.w}},quat:function(a){return{w:a.w,x:a.x,y:a.y,z:a.z}},mat3:function(a){return{"0":this.vec3(a[0]),1:this.vec3(a[1]),2:this.vec3(a[2])}},mat4:function(a){return{"0":this.vec4(a[0]),1:this.vec4(a[1]),2:this.vec4(a[2]),3:this.vec4(a[3])}}},$from_glsl:{string:function(a){var b;a.replace(/^(\w+)\(([-.0-9ef, ]+)\)$/,function(a,d,e){b=glm[d].apply(glm,e.split(",").map(parseFloat))});return b}}}),GLM.$template.varargs_functions({$to_glsl:{"vec<N>":function(a){for(var b=
GLM.$to_array(a);b.length&&b[b.length-2]===b[b.length-1];)b.pop();return a.$type+"("+b+")"},"uvec<N>":function(a){return this.vecN(a)},quat:function(a){return 0===a.x+a.y+a.z?"quat("+a.w+")":"quat("+GLM.$to_array(a)+")"},"mat<N>":function(a){a=GLM.$to_array(a);return a.reduce(function(a,c){return a+c},0)===a[0]*N?"matN("+a[0]+")":"matN("+a+")"}}}));
...
b)},"mat<N>,mat<N>":function(a,b){return this.$eq(a,b)},"quat,quat":function(a,b){return this.$eq(a,b)},"uvec<N>,uvec<N>":function(a,b){return this.$eq(a,b)}}});GLM.string={$type_name:"string",$:{}};GLM.number={$type_name:"float",$:{}};
...
(function(){var a=function(a,b,e,f){a.$properties=a.$properties||{def:function(b,d){this[b]=d;Object.defineProperty(a.prototype,b,d)}};var g=a.$properties,h=g.def,k=[0,1,2,3].map(function(a){return{enumerable:e,get:function(){return this.elements[a]},set:function(b){this.elements[a]=b}}});b.forEach(function(a,b){h(a,k[b])});if(isNaN(b[0])&&!/^_/.test(b[0])){var i=b.slice();do(function(a,b,c){"quat"===b&&(b="vec"+c);h(a,{enumerable:!1,get:function(){return new GLM[b](this.elements.subarray(0*c,1*c))},
set:function(a){return(new GLM[b](this.elements.subarray(0*c,1*c)))["="](a)}})})(i.join(""),a.prototype.$type.replace(/[1-9]$/,i.length),i.length);while(i[1]!=i.pop());if(f)return g;i=b.slice();if(b={xyz:{yz:1},xyzw:{yzw:1,yz:1,zw:2}}[i.join("")])for(var j in b)(function(a,b,c,d){h(a,{enumerable:!1,get:function(){return new GLM[b](this.elements.subarray(0*c+d,1*c+d))},set:function(a){return(new GLM[b](this.elements.subarray(0*c+d,1*c+d)))["="](a)}})})(j,a.prototype.$type.replace(/[1-9]$/,j.length),
j.length,b[j])}return g};a(GLM.vec2,GLM.vec2.$.components[0],!0);a(GLM.vec2,GLM.vec2.$.components[1]);a(GLM.vec3,GLM.vec3.$.components[0],!0);a(GLM.vec3,GLM.vec3.$.components[1]);a(GLM.vec3,GLM.vec3.$.components[2]);a(GLM.vec4,GLM.vec4.$.components[0],!0);a(GLM.vec4,GLM.vec4.$.components[1]);a(GLM.vec4,GLM.vec4.$.components[2]);a(GLM.quat,GLM.quat.$.components[0],!0,"noswizzles");a(GLM.quat,GLM.quat.$.components[1]);GLM.quat.$properties.def("wxyz",{enumerable:!1,get:function(){return new GLM.vec4(this.w,
this.x,this.y,this.z)},set:function(a){a=GLM.vec4(a);return this["="](GLM.quat(a.x,a.y,a.z,a.w))}});a(GLM.uvec2,GLM.uvec2.$.components[0],!0);a(GLM.uvec2,GLM.uvec2.$.components[1]);a(GLM.uvec3,GLM.uvec3.$.components[0],!0);a(GLM.uvec3,GLM.uvec3.$.components[1]);a(GLM.uvec4,GLM.uvec4.$.components[0],!0);a(GLM.uvec4,GLM.uvec4.$.components[1]);Object.defineProperty(GLM.quat.prototype,"_x",{get:function(){throw Error("erroneous quat._x access");}});var b=Float32Array.BYTES_PER_ELEMENT;GLM.$partition=
function(a,d,e,f){if(void 0===e)throw new GLM.GLMJSError("nrows is undefined");var g=d.$.identity.length;e=e||g;for(var h=function(a){GLM.$DEBUG&&GLM.$outer.console.debug("CACHEDBG: "+a)},k=b*g,i=0;i<e;i++)(function(b){var e=b*k,i=f&&f+b,n=b*g;Object.defineProperty(a,b,{configurable:!0,enumerable:!0,set:function(e){if(e instanceof d)this.elements.set(e.elements,n);else if(e&&e.length===g)this.elements.set(e,n);else throw new GLM.GLMJSError("unsupported argtype to "+(a&&a.$type)+"["+b+"] setter: "+
[typeof e,e]);},get:function(){if(f){if(this[i])return b||h("cache hit "+i),this[i];b||h("cache miss "+i)}var a,c=new d(a=new Float32Array(this.elements.buffer,this.elements.byteOffset+e,g));if(c.elements!==a)throw new GLM.GLMJSError("v.elements !== t");f&&Object.defineProperty(this,i,{configurable:!0,enumerable:!1,value:c});return c}})})(i)};GLM.$partition(GLM.mat4.prototype,GLM.vec4,4,"_cache_");GLM.$partition(GLM.mat3.prototype,GLM.vec3,3,"_cache_")})();
...
_mulVecMat4:tdl.fast.rowMajor.mulVectorMatrix4,"mat4,vec4":function(a,b){return glm.vec4(this._mulVecMat4(new Float32Array(4),b.elements,a.elements))},"_mulMatMat<N>":"tdl.fast.columnMajor.mulMatrixMatrixN","mat<N>,mat<N>":function(a,b){return glm.matN(this._mulMatMatN(new Float32Array(N*N),a.elements,b.elements))}},mul_eq:{$op:"*=","vec<N>,float":function(a,b){tdl.fast.mulVectorScalar(a.elements,a.elements,b);return a},"_mulMatMat<N>":"tdl.fast.columnMajor.mulMatrixMatrixN","mat<N>,mat<N>":function(a,
...
DLL.functions={mix:{"quat,quat":function(a,b,c){a=a.elements;b=b.elements;var d=glm.quat(new Float32Array(4)),e=d.elements,f=a[0],g=a[1],h=a[2],k=a[3],i=b[0],j=b[1],l=b[2];b=b[3];var m=f*i+g*j+h*l+k*b,n;if(1<=Math.abs(m))return e!==a&&(e[0]=f,e[1]=g,e[2]=h,e[3]=k),d;a=Math.acos(m);n=Math.sqrt(1-m*m);m=Math.sin((1-c)*a)/n;c=Math.sin(c*a)/n;e[0]=f*m+i*c;e[1]=g*m+j*c;e[2]=h*m+l*c;e[3]=k*m+b*c;return d}}};
