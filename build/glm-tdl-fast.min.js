...
"<T,...>":function(a,b){a.$sig="<T,...>";var c=GLM.$template.jstypes;return this.slingshot(this._inline_helpers(a,b),eval(this._traceable("Tdotglm_"+b,function(b){for(var e=Array(arguments.length),f=0;f<e.length;f++)e[f]=arguments[f];this instanceof GLM.$GLMBaseType&&e.unshift(b=this);f=[b&&b.$type||c[typeof b]||c.get(b)||"null"];if(!a[f])throw GLM.$template._genArgError(a,arguments.callee.dbg,f,e);return a[f].apply(a,e)}))())},"<T,V,n>":function(a,b){a.$sig="<T,V,n>";var c=GLM.$template.jstypes;
return this.slingshot(this._inline_helpers(a,b),eval(this._traceable("TVnglm_"+b,function(){for(var b=Array(arguments.length),e=0;e<b.length;e++)b[e]=arguments[e];this instanceof GLM.$GLMBaseType&&b.unshift(this);var e=b[0],f=b[1],b=b[2],g=[e&&e.$type||c[typeof e]||c[e+""]||"<unknown "+e+">",f&&f.$type||c[typeof f]||c[f+""]||"<unknown "+f+">"];if(!a[g])throw GLM.$template._genArgError(a,arguments.callee.dbg,g,[e,f,b]);if("number"!==typeof b)throw new GLM.GLMJSError(arguments.callee.dbg+a.$sig+": unsupported n type: "+
[typeof b,b]);return a[g](e,f,b)}))())},"<T,V>":function(a,b){a.$sig="<T,V>";var c=GLM.$template.jstypes,d=GLM.$GLMBaseType,e=GLM.$template._genArgError;return this.slingshot(this._inline_helpers(a,b),eval(this._traceable("TVglm_"+b,function(){for(var b=Array(arguments.length),g=0;g<b.length;g++)b[g]=arguments[g];this instanceof d&&b.unshift(this);var g=b[0],h=b[1],g=[g&&g.$type||c[typeof g],h&&h.$type||c[typeof h]||c[h+""]||Array.isArray(h)&&"array"+h.length+""||""+h+""];if(!a[g])throw e(a,arguments.callee.dbg,
g,b);return a[g].apply(a,b)}))())},override:function(a,b,c,d){GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: ",a,b,c.$op?'$op: ["'+c.$op+'"]':"");if(!d)throw Error("unspecified target group "+d+' (expected override(<TV>, "p", {TSP}, ret={GROUP}))');var e=d[b];if(e&&e.$op!==c.$op)throw Error('glm.$template.override: mismatch merging existing override: .$op "'+[e.$op,"!=",c.$op].join(" ")+'"  p='+[b,e.$op,c.$op,"||"+Object.keys(e.$template).join("||")]);var f=GLM.$template[a](GLM.$template.deNify(c,
b),b);f.$op=c.$op;if(e){var g=[],h;for(h in f.$template)h in e.$template||(GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+h+" overlayed"),e.$template[h]=f.$template[h]);Object.keys(e.$template).forEach(function(a){a in f.$template||(GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+a+" carried-forward"),g.push(a))});GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+Object.keys(d[b].$template).filter(function(a){return!~a.indexOf("$")}).map(function(a){return!~g.indexOf(a)?
"*"+a+"*":a}).join(" | "))}else d[b]=f,GLM.$DEBUG&&GLM.$outer.console.debug("glm.$template.override: "+b+" ... "+Object.keys(d[b].$template).filter(function(a){return!~a.indexOf("$")}).map(function(a){return"*"+a+"*"}).join(" | "));return d},_override:function(a,b,c){for(var d in b)this.override(a,d,b[d],c);return c},slingshot:function(){return this.extend.apply(this,[].reverse.call(arguments))},extend:function(a,b){[].slice.call(arguments,1).forEach(function(b){for(var d in b)b.hasOwnProperty(d)&&
(a[d]=b[d])});return a},operations:function(a){return this._override("<T,V>",a,GLM.$outer.functions)},calculators:function(a){return this._override("<T>",a,GLM.$outer.functions)},varargs_functions:function(a){return this._override("<T,...>",a,GLM.$outer.functions)},functions:function(a){return this._override("<T,V,n>",a,GLM.$outer.functions)},_tojsname:function(a){return(a||"_").replace(/[^$a-zA-Z0-9_]/g,"_")},_traceable:function(a,b){if("function"!==typeof b)throw new GLM.GLMJSError("_traceable expects tidy function as first arg "+
b);if(!a)throw new GLM.GLMJSError("_traceable expects hint or what's the point"+[b,a]);a=this._tojsname(a||"_traceable");b=(b+"").replace(/^(\s*var\s*(\w+)\s*=\s*)__VA_ARGS__;/mg,function(a,b,e){return b+"new Array(arguments.length);for(var I=0;I<varname.length;I++)varname[I]=arguments[I];".replace(/I/g,"__VA_ARGS__I").replace(/varname/g,e)});if(2===b.split(/^\s*function\b/).length)b=(function(){SRC;return HINT}+"").replace("HINT",a).replace("SRC",b.replace(/^function\s*\(/,"function "+a+"("));else throw new GLM.GLMJSError("expected singular anonymous function: "+
[b,a]);return"1,"+b},deNify:function(a,b){var c={vec:[2,3,4],mat:[3,4]},d=this._tojsname.bind(this),e;for(e in a){var f=!1;e.replace(/([vV]ec|[mM]at)(?:\w*)<N>/,function(g,h){f=!0;var k=a[e];delete a[e];c[h.toLowerCase()].forEach(function(c){var f=e.replace(/<N[*]N>/g,c*c).replace(/<N>/g,c);if(!(f in a)){var g=d("glm_"+b+"_"+f);a[f]=(new Function("","return "+(k+"").replace(/^function\s*\(/,"function "+g+"(").replace(/N[*]N/g,c*c).replace(/N/g,c)))()}})}.bind(this));/^[$]/.test(e)?GLM.$DEBUG&&GLM.$outer.console.debug("@ NOT naming "+
e):!f&&("function"===typeof a[e]&&!a[e].name)&&(GLM.$DEBUG&&GLM.$outer.console.debug("naming "+d(b+"_"+e)),a[e]=eval(this._traceable("glm_"+b+"_"+e,a[e]))())}return a},$_module_stamp:+new Date,GLMType:function(a,b){var c=b.identity.length;Object.keys(b).filter(function(a){return"function"===typeof b[a]&&!b[a].name}).map(function(c){var d=a+"_"+c;GLM.$DEBUG&&GLM.$outer.console.debug("naming $."+c+" == "+d,this._traceable(d,b[c]));b[c]=eval(this._traceable("glm_"+d,b[c]))()}.bind(this));var d=eval(this._traceable("glm_"+
a+"$class",function(a){for(var b=d.$,c=d.prototype.$type,h=Array(arguments.length),k=0;k<h.length;k++)h[k]=arguments[k];var i=typeof a+h.length,k=b[i];if(!k)throw new GLM.GLMJSError("no template found for "+c+".$."+i);if(this instanceof d){if(a instanceof Float32Array){if(a.length!=d.componentLength)throw GLM.$outer.console.error(c+" elements size mismatch: "+["wanted:"+d.componentLength,"handed:"+a.length]),b=a.subarray(0,d.componentLength),new GLM.GLMJSError(c+" elements size mismatch: "+["wanted:"+
d.componentLength,"handed:"+a.length,"theoreticaly-correctable?:"+(b.length===d.componentLength)]);c=a}else(c=new Float32Array(d.componentLength)).set(k.apply(b,h));Object.defineProperty(this,"elements",{enumerable:!1,configurable:!0,value:c})}else return new d(k.apply(b,h))}))();b.components=b.components?b.components.map(function(a){return"string"===typeof a?a.split(""):a}):[];d.$=b;d.componentLength=c;d.BYTES_PER_ELEMENT=c*Float32Array.BYTES_PER_ELEMENT;d.prototype=new GLM.$GLMBaseType(d,a);return d}};
...
return a};try{module.exports=GLM}catch(e$$17){}tdl.fast.exists;glm=GLM;
